...
const ProblemPage = () => {
  ...
  const fetchTags = async () => {
    try {
      const response = await axios.get('http://16.16.201.79:5050/api/problems/tags');
  ...
  const fetchDifficulties = async () => {
    try {
      const response = await axios.get('http://16.16.201.79:5050/api/problems/difficulties');
  ...
  const fetchSolvedProblems = async (userId) => {
    try {
      const response = await axios.get(`http://16.16.201.79:5050/api/users/${userId}/solvedProblems`);
